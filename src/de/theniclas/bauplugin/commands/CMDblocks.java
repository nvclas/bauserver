		...
		if(command.getName().equalsIgnoreCase("blocks")) {
			if(sender instanceof Player) {
				...
				if(p.hasPermission("bs.blocks")) {
					...
					inv.addItem(Vars.getSkull("http://textures.minecraft.net/texture/8dd0cd158c2bb6618650e3954b2d29237f5b4c0ddc7d258e17380ab6979f071", "§fVolle Steinstufe"));
					inv.addItem(Vars.getSkull("http://textures.minecraft.net/texture/d36e9862832a6fcc4855fa79c1aae5e73b9197ec6bbd38f6312efac680c63285", "§fVolle Sandsteinstufe"));
					inv.addItem(Vars.getSkull("http://textures.minecraft.net/texture/a2da7aa1ae6cc9d6c36c18a460d2398162edc2207fdfc9e28a7bf84d7441b8a2", "§fVolle Rote Sandsteinstufe"));
